...
class DatabaseManager extends IlluminateDatabaseFactory
{
    ...
    /**
     * @return null|Illuminate\Database\Capsule\Manager
     *
     */
    public static function getInstance()
    {
        if (self::$config['enabled'] === true) {
            IlluminateDatabaseFactory::setSettings(self::$config['settings']);

            return IlluminateDatabaseFactory::createInstance();
        } else {
            return;
        }
    }
 ...
 * -------------------
 * This is to store the configurations for Application and ApplicationModule Classes
 */
class DocumentManager
{
    public function __construct()
    {
        $doc = new DocumentDB("../../Config", "config_db", DocumentDB::DSO_FOLDER, false);
